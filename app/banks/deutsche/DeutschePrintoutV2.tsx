  ...
  return (
    <div translate="no" className="notranslate bg-gray-200 min-h-screen pb-10">
      ...
      <div id="printable-area" className="max-w-[210mm] mx-auto bg-white shadow-2xl printable-container">
        ...
        {/* PAGE 3 */}
        <div className="page-break bg-white relative" style={{ minHeight: '297mm' }}>
        ...
        {/* PAGE 4 */}
        <div className="p-10 page-break bg-white relative text-sm font-sans" style={{ minHeight: '297mm' }}>
        ...
        {/* PAGE 5 */}
        <div className="p-10 page-break bg-white text-sm font-sans" style={{ minHeight: '297mm' }}>
