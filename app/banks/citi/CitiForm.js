  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
      ...
      <div className="flex items-center gap-4 mb-6 pb-4 border-b border-gray-200">
        <div className="w-12 h-12 bg-blue-800 rounded-lg flex items-center justify-center text-white font-bold text-sm">Citi</div>
        <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., PT CITI GLOBAL ASSETS"
            />
          </div>
          <div>
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="e.g., JALAN JENDERAL SUDIRMAN KAV 54-55, JAKARTA"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., CITI587069248914"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., INVESTMENT SETTLEMENT"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="e.g., PT CITI BENEFICIARY INDO"
              required
            />
          </div>
        </div>
      ...
      <button type="submit" className="w-full bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl text-lg">
        🚀 GENERATE CITI MT103 TRANSACTION
      </button>
