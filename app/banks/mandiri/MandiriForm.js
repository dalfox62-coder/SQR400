  ...
  return (
    <form onSubmit={handleSubmit} className="bg-slate-900/30 border border-slate-850 rounded-3xl p-6 md:p-8 shadow-2xl backdrop-blur-md relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 mb-6 pb-5 border-b border-slate-855">
        <div className="w-12 h-12 bg-amber-500/10 text-amber-400 border border-amber-900/30 rounded-xl flex items-center justify-center font-black text-xs tracking-wider shadow-lg">
          MDR
        </div>
        <div>
          <h2 className="text-base font-bold text-white tracking-widest uppercase">MANDIRI NODE</h2>
      ...
      <div className={sectionClass}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="date"
              className="w-full px-3 py-2 bg-slate-950 border-2 border-slate-800 focus:border-yellow-500 rounded-xl text-xs text-slate-100 outline-none focus:ring-2 focus:ring-yellow-900/30"
